...
public class ControladorSalsa 
{
    ...
    public boolean ingresarSalsa (String nombre, int precioporcion, int cantidad, String tipo,int azucares, int carbohidratos, int grasa, byte [] foto)
    {
        ...
        salsa.setCarbohidratos(carbohidratos);
        salsa.setAzucares(azucares);
        salsa.setGrasa(grasa);
        salsa.setFoto(foto);
        try 
        {
